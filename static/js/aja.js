$(function() {
            ...
            $('#chatbot-form').submit(function(e) {
                e.preventDefault();
                var bot_name= "HelloESG : "
                var user_name = "You : "
                var message = $('#messageText').val();
                if(message!=""){
                $(".media-list").append('<li class="media"><div class="media-body"><div class="media"><div class="media-body">' + user_name.concat(message) + '<hr/></div></div></div></li>');
                $.ajax({
                    type: "POST",
                    url: "/ask",
                    data: $(this).serialize(),
